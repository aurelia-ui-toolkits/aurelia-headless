...
import { UiAlertModal } from './alert-service/alert-modal/ui-alert-modal';
import { AlertService } from './alert-service/alert-service';
import { ExceptionsTracker } from './alert-service/exceptions-tracker';
import { UiPromptDialog } from './alert-service/prompt-dialog/ui-prompt-dialog';
...
const HeadlessDialogConfiguration = DialogConfigurationStandard.customize(settings => {
  settings.options.closedby = 'any';
});
...
export type { IPromptDialogData } from './alert-service/prompt-dialog/ui-prompt-dialog';
